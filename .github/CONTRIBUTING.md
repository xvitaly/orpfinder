...
This document describes how you can contribute to orpfinder. Please read it carefully.
...
## Pull requests
 ...
 ```bash
 git clone git@github.com:YOURNAME/orpfinder.git
 ```
 ...
 ```bash
 git remote add upstream https://github.com/EasyCoding/orpfinder.git
 ```
